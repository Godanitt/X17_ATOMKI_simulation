...
# Physics mixture: IPC-like smooth pairs are the main background.
# Override at runtime, e.g. SIGNAL_FRACTION=0.05 bash scripts/run_all.sh
SIGNAL_FRACTION="${SIGNAL_FRACTION:-0.10}"
IPC_THETA_SLOPE_PER_DEG="${IPC_THETA_SLOPE_PER_DEG:-0.018}"
...
echo "==> Generator mixture: X17 signal fraction=${SIGNAL_FRACTION}, IPC theta slope=${IPC_THETA_SLOPE_PER_DEG} per degree"
X17_SIGNAL_FRACTION="${SIGNAL_FRACTION}" \
X17_IPC_THETA_SLOPE_PER_DEG="${IPC_THETA_SLOPE_PER_DEG}" \
