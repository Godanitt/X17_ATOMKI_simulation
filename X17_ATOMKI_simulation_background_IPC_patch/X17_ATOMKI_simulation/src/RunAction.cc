...
RunAction::RunAction()
{
    ...
    // Event component produced by PrimaryGeneratorAction:
    //   0 = IPC-like smooth e-/e+ pair background (dominant by default)
    //   1 = X17-like signal from data/data_pair_creation.txt
    // Reserved for later extensions:
    //   2 = accidental coincidence
    analysis->CreateNtupleIColumn("componentID");                // 35
